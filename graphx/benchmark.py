"""Token-reduction benchmark - measures how much context graphx saves vs naive full-corpus approach."""
...
def run_benchmark(
    graph_path: str = "graphx-out/graph.json",
    corpus_words: int | None = None,
    questions: list[str] | None = None,
) -> dict:
    """Measure token reduction: corpus tokens vs graphx query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\ngraphx token reduction benchmark")
    print(f"{'─' * 50}")
