"""Tests for graphx/security.py - URL validation, safe fetch, path guards, label sanitisation."""
...
def test_safe_fetch_returns_bytes(tmp_path):
    ...
    with patch("graphx.security._build_opener") as mock_opener_fn:
