...
Example output:
    === GraphX AST Extraction Benchmark ===
    Files:        1,247
...
from graphx.extract import extract, collect_files
from graphx.cache import clear_cache
...
def main() -> None:
    ...
    print("=== GraphX AST Extraction Benchmark ===\n")
