# GraphX Evaluation - Mixed Corpus (2026-04-04)
...
**Finding:** Communities are semantically correct - the three graphx modules map cleanly
...
detect() on eval root with graphx-out/memory/ present:
...
**What graphx extracts (Claude vision reads directly, no reshaper/bidi needed):**
...
identically to English. The image node in graphx is just a path - the vision subagent does
the rest.
