# GraphX Evaluation - httpx Corpus (2026-04-03)
...
**Pipeline:** graphx AST extractor + graph_builder + Leiden clusterer + analyzer + reporter
**Method:** Full deterministic code tracing of every graphx source module against
...
```markdown
# Graph Report - /home/safi/graphx_test/httpx  (2026-04-03)
...
The graphx AST extractor is deterministic, fast, and accurate for what it extracts.
